...
export const Register: React.FC = () => {
  ...
  const validatePassword = (value: string): string | null => {
    ...
    // разрешаем только латиницу, цифры и спецсимволы
    // (запрещаем кириллицу и прочие буквы вне A–Z)
    const onlyLatinDigitsAndSymbols = /^[\x20-\x7E]+$/;
    if (!onlyLatinDigitsAndSymbols.test(value)) {
            ...
            <Box>
              ...
              >
                ...
                >
                  ...
                  <li>Только латинские буквы, цифры и спецсимволы.</li>
